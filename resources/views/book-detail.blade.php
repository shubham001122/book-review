...
<div class="container mt-3 ">
    <div class="row justify-content-center d-flex mt-5">
        ...
        <div class = "alert alert-success">{{ Session::get('review') }}</div> 
            ...
            @if(Session::has('no_review'))
        <div class = "alert alert-danger">{{ Session::get('no_review') }}</div> 
            @endif
                    ...
                    @foreach($randomBooks as $randomBook )    
                        <div class="col-md-4 col-lg-4 mb-4">
                            <div class="card border-0 shadow-lg">
                                <img src={{ asset('uploads/books/'.$randomBook->image) }} alt="" class="card-img-top">
                                <div class="card-body">
                                    <h3 class="h4 heading">{{ $randomBook->title }}</h3>
                        ...
                        <div class="col-md-12  mt-4">
                            <div class="d-flex justify-content-between">
                                ...
                                @if(Auth::check())   
                                 ...
                                 @else
                                    <a type="submit" href="{{ route('account.login') }}" class="btn btn-primary">
                                        Add Review
                                    </a>     
...
$("#review-error").addClass('invalid-feedback');
...
$("#review-error").removeClass('invalid-feedback'); 
$("#review-error").html(" ");  
   }  
